    ...
    <nav className="bg-customblack pt-8 relative">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        <a className="flex items-center space-x-20 rtl:space-x-reverse mt-4">
          ...
          <button
            type="button"
            className="text-white bg-secondary hover:bg-secondary-ligth focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center md:text-left dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center"
        ...
        <div className="hidden w-full md:block md:w-auto mr-12 mt-4" id="navbar-default">
          <ul className="font-small flex flex-col md:p-0 md:flex-row md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0">
            <li>
       ...
       <div className="relative w-full max-w-md">
         <div className="relative bg-gray-800 rounded-lg shadow dark:bg-gray-800">
           <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-700">
             <p className="text-lg text-white font-medium">Welcome again</p>
             <button
               type="button"
           ...
           <div className="p-6 space-y-6 bg-gray-800">
             <p className="text-center text-lg text-white font-medium">Log in</p>
             <div className="space-y-4">
               <button
                 className="w-full px-4 py-2 text-sm font-medium text-white bg-[#19191E] rounded-lg hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
               ...
               {/* Línea con texto "Or" en el centro */}
