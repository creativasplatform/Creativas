...
const Sidebar = ({ onClose }) => {
        ...
        return (
          <div>
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <button className="bg-secondary text-white p-2 rounded-lg">Explorar las NFT</button>
            </div>
          </div>
        );
      case 'Rewards':
        return (
          <div>
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-gray-500">Aún no hay Recompensas</p>
              <p className="text-gray-400 text-sm mb-4 text-center">Compre o transfiera NFT a esta billetera para comenzar.</p>
              <button className="bg-secondary text-white p-2 rounded-lg">Explorar las NFT</button>
            </div>
          </div>
        ...
        return (
          <div>
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-gray-400 text-sm mb-4 text-center">Tus transacciones en cadena y compras de criptomonedas aparecerán aquí.</p>
            </div>
          </div>
        );
      default:
  ...
  return (
    ...
    <div className="w-[400px] bg-customblack shadow-lg p-4 h-full fixed right-0 top-0">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center">
          <button onClick={onClose} className="ml-40">
      ...
      <div className="grid grid-cols-2  gap-2 mb-6">
        <button className="bg-secondary/40 p-4 rounded-[20px] flex flex-col items-center ">
          <img role="img" aria-label="buy" className="ml-0" src={Tarjeta}></img>
          <p className="text-secondary mt-2 ml-0 text-[16px] mr-[85px] font-bold">Comprar</p>
        </button>
        <button className="bg-secondary/40 p-4 rounded-[20px] flex flex-col items-center">
          <img role="img" aria-label="buy" className="ml-0" src={imagen}></img>
          <p className="text-secondary mt-2 ml-0 text-[16px] mr-[85px] font-bold">Ver NFT</p>
        </button>
      </div>
